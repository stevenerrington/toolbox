...
%
% ARGUMENTS:
%           x           --  signal matrix of continuous data [N samples,
%                           M channels]
%           nfft        --  length of fft, zero-padded if window has less
%                           than n points
%           events      --  the events or triggers in the continuous data 
%                           used to segment the data; the spectral measures
%                           are computed (averaged) across these segments
