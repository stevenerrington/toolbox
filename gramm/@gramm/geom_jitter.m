...
hndl=line(draw_data.x,draw_data.y,'LineStyle','none','Marker',draw_data.marker,'MarkerEdgeColor','k','markerSize',draw_data.point_size,'MarkerFaceColor',draw_data.color(1:3));
